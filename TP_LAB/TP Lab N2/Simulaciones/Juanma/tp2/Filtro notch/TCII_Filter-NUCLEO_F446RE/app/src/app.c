...
float32_t iir_state[IIR_SOS_NUM*4]; //arm_biquad_cascade_df1_f32 requiere 4 estados por sección biquad
...
//Coeficientes generados por python/diseno_filtros.py (formato CMSIS {b0,b1,b2,a1,a2} por sección)
//Filtro A: Chebyshev pasabajos (fp=100Hz, fs=300Hz, amax=1dB, amin=60dB) @ fs=1kHz
