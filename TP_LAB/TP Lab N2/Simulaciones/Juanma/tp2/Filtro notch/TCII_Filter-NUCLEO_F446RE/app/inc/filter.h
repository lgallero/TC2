...
// Filtro diseñado en python/diseno_filtros.py con scipy.signal.iirdesign
// Chebyshev pasabajos: fp=100Hz, fs=300Hz, amax=1dB, amin=60dB (@ SAMPLE_RATE=1kHz)
#define IIR_SOS_NUM 2

// arm_biquad_cascade_df1_f32 espera 5 coeficientes {b0,b1,b2,a1,a2} por sección
#define IIR_TAP_NUM (IIR_SOS_NUM*5)

#define SAMPLE_RATE_1K	1000ul
#define SAMPLE_RATE_20K	20000ul
#define SAMPLE_RATE_40K	40000ul

#define SAMPLE_RATE	SAMPLE_RATE_1K
